    ...
    for line in vcf:
        if re.match(b"^##", line):
            ...
            if len(REF) > 1 or len(ALT) > 1:
                ...
                continue
            elif re.match("\.", con[index_F_h[0]]):
                continue
            elif re.match("\.", con[index_M_h[0]]):
                continue
            elif re.match("\.", con[index_F_l[0]]):
                continue
            elif re.match("\.", con[index_M_l[0]]):
                continue
            else:
                ...
                if sum([geno_F1_h, geno_F2_h, geno_M1_h, geno_M2_h, geno_F1_l, geno_F2_l, geno_M1_l, geno_M2_l]) == 4 and (sum([geno_F1_h, geno_F2_h, geno_M1_h, geno_M2_h]) == 0 or sum([geno_F1_h, geno_F2_h, geno_M1_h, geno_M2_h]) == 4 ):
                    ...
                    #print(geno_F1_h + geno_M2_h, geno_F1_l+ geno_M2_l)