...
ID_of = re.compile(str(380))
vcf_file = "/Users/yanjunzan/Documents/impute/git/data/180208.all.223+700.f2.P60.vcf.gz"
Fid_h = re.compile(str(".*1812.*"))
Mid_h = re.compile(str(".*1653.*"))
Fid_l = re.compile(str(".*2109.*"))
Mid_l = re.compile(".*1997.*")
...
out_file = "/Users/yanjunzan/Documents/impute/data/180215.380.frompy.vcf"
